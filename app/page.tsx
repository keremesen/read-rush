...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 md:p-24 relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[50%] -translate-x-1/2 w-[800px] h-[800px] bg-accent/5 rounded-full blur-3xl pointer-events-none" />
      ...
      {(appState === "reading" || appState === "completed") && (
        <div className="z-10 w-full max-w-4xl flex flex-col items-center gap-8 animate-in fade-in zoom-in-95 duration-300">
           ...
           <div className="flex items-center gap-6">
              ...
              >
                {isPlaying ? (
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/></svg>
                ) : (
           ...
           {appState === "completed" && (
              <div className="text-center animate-in fade-in slide-in-from-bottom-2">
                 ...
                 <button onClick={handleReset} className="text-accent hover:underline font-medium">Read something else</button>
              </div>
           )}
