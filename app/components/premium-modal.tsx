...
export function PremiumModal({ isOpen, onClose }: PremiumModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div
        className={`relative w-full max-w-md bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl p-6 md:p-8 transform transition-all duration-300 ${isOpen ? "scale-100 translate-y-0" : "scale-95 translate-y-4"}`}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-foreground">Unlock AI Generation</h2>
