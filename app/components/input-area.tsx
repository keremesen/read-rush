      ...
      <div className="w-full max-w-2xl flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
        <div className="relative group">
          ...
          <div className="absolute bottom-4 left-4 flex items-center gap-2">
            {[
              { label: "Short", text: "Speed reading is a skill that allows you to absorb information faster." },
              { label: "Medium", text: "Rapid Serial Visual Presentation (RSVP) is a method of displaying information (generally text) in which text is displayed piece-by-piece in a fixed focal position. This eliminates the time spent on eye movements." },
              { label: "Long", text: "Reading is a complex cognitive process of decoding symbols in order to construct or derive meaning. Reading is a means of language acquisition, communication, and of sharing information and ideas. Like all languages, it is a complex interaction between the text and the reader which is shaped by the reader's prior knowledge, experiences, attitude, and language community which is culturally and socially situated. The reading process requires continuous practice, development, and refinement." }
            ].map((sample) => (
              <button
                key={sample.label}
